      ...
      <div className="container">
        <div className="row">
          <div className="col-md-5">
            <img class="aboutImage" src="img/me.jpeg" />
          </div>
          ...
          <div className="col-md-7">
            ...
            <p>
              ...
              experience creating software, for both myself, and for clients. I
              have experience programming in many different languages such as
              C#, Java, PHP and Python.
            </p>
            <p>
              I'm graduate of the University of Informatics Sciences of Cuba (
              <a href="https://www.uci.cu/">UCI</a>) in 2015. From my third year
              until the end of the degree I completed an internship in the LPS
              Aplicativos SIG project, belonging to{" "}
              ...
              (Center for Geoinformatics and Digital Signals) . In this project
              I completed my degree thesis, CRUD Generator for the LPS
              APLICATIVOS SIG. After graduating I was working at the
              International Institute of Journalism (
              <a href="https://periodismojosemarti.wordpress.com">IIPJM</a>) and
              later in the telecommunications company of Cuba (
